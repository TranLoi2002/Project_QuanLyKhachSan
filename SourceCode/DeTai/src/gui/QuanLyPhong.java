...
public class QuanLyPhong extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		jPanel1.setBorder(BorderFactory.createTitledBorder(null, "Thông tin phòng",
				TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION,
				new Font("Segoe UI", 0, 18))); // NOI18N
		...
		btn_themPhong_Phong.setFont(new Font("Segoe UI", 1, 14)); // NOI18N
		...
		btn_SuaPhong_Phong.setFont(new Font("Segoe UI", 1, 14)); // NOI18N
		...
		btn_XoaPhong_Phong.setFont(new Font("Segoe UI", 1, 14)); // NOI18N
		...
		btn_XoaPhong_Phong.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int choice = JOptionPane.showConfirmDialog(null, "Bạn có chắc muốn xóa không ?", maP, JOptionPane.YES_NO_CANCEL_OPTION);
		...
		btn_Clear_Phong.setFont(new Font("Segoe UI", 1, 14)); // NOI18N
		...
		txt_LoaiPhong_Phong.setModel(
				new DefaultComboBoxModel<String>(new String[] { "--Select--", "Phong Gia dinh", "Phong Don", "Phong Doi" }));
		txt_TinhTrang_Phong
	...
	private void edit_Phong() {
		int row = jtable_Phong.getSelectedRow();
		if (row == -1) {
			JOptionPane.showMessageDialog(this, "Bạn chưa chọn phòng để sửa thông tin!");
		} else {
